...
html {
	...
	font-size: 14px;
	background: -webkit-linear-gradient(rgba(5, 610, 255, 0.4),
		rgba(135, 60, 255, 0.0) 80%),
		-webkit-linear-gradient(-45deg, rgba(120, 155, 255, 0.9) 25%,
		rgba(255, 160, 65, 0.9) 76%);
}
...
<body>
	...
	<ul class="menu cf">
		...
		<li><a href="${context}/showlogin">Login</a>
		...
		<li><a href="${context}/register">Register</a>
	...
	<div class="card-grid">
		<a class="card" href="${context}/showlogin">
			<div class="card__background"
				style="background-image: url(https://images.unsplash.com/photo-1515879218367-8466d910aaa4?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80)">
			</div>
			<div class="card__content">
				<p class="card__category">Education</p>
				<h3 class="card__heading">Learn to code</h3>
			</div>
		</a> <a class="card" href="${context}/showlogin">
			<div class="card__background"
				style="background-image: url(https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=702&q=80)"></div>
			<div class="card__content">
				<p class="card__category">Education</p>
			...
			</li> <a class="card" href="${context}/register">
				<div class="card__background"
					style="background-image: url(https://images.unsplash.com/photo-1554415707-6e8cfc93fe23?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80)"></div>
				<div class="card__content">
